...
let timeoutClosure = {(endpoint:Endpoint<ZCApi>, closure:MoyaProvider<ZCApi>.RequestResultClosure) -> Void in
...
let ApiProvider = MoyaProvider<ZCApi>(requestClosure:timeoutClosure)

let ApiLoadingProvider = MoyaProvider<ZCApi>(requestClosure:timeoutClosure,plugins:[LoadingPlugin])
